...
修改 --insecure-registry 10.0.0.0/24
...
[如何在 Minikube 中使用本地 docker 镜像](http://nibes.cn/blog/8113)

本地docker 可以通过新建 /etc/docker/daemon.json
...
`sudo journalctl -exu kubelet/kubeadm`

发现 阿里云的镜像 没有pull pause:3.6
...
要注意 kubernetes 1.24.1 和1.24.2 引用的镜像版本不同
...
[【已解决】pod/nginx-ingress-controller一直处于Pending状态，异常如下](https://coding.imooc.com/learn/questiondetail/AKpB2XJAdm9Ybv0E.html)
...
[kubectl-commands](https://kubernetes.io/docs/reference/generated/kubectl/kubectl-commands#port-forward)
